...
class RequestChangeMessagePage extends StatefulWidget {
  final String userName;

  const RequestChangeMessagePage({super.key, required this.userName});

  @override
  _RequestChangeMessagePage createState() => _RequestChangeMessagePage();
}

class _RequestChangeMessagePage extends State<RequestChangeMessagePage> {
